...
const PAYMENT_METHODS = [
  {
    ...
    description: "Transferí al alias indicado y subí el comprobante.",
  },
  {
    value: "CASH",
    label: "Efectivo",
    description: "Pagás al retirar o al momento de la entrega.",
  },
];
      ...
      <div className="ow-overlay">
        <div className="ow-modal">
          <div className="ow-success">
            ...
            <p>
              Tu pedido fue creado correctamente. El equipo calculará el costo
              de envío y te lo informaremos a la brevedad para que puedas
              confirmar.
            </p>
    ...
    <div className="ow-overlay" onClick={onClose}>
      <div className="ow-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="ow-steps">
          {STEPS.map((s, i) => (
            <React.Fragment key={s.id}>
              <div
                className={`ow-step ${step === s.id ? "active" : step > s.id ? "done" : ""}`}
              >
              ...
              {i < STEPS.length - 1 && (
                <div
                  className={`ow-step-connector ${step > s.id ? "done" : ""}`}
                />
              )}
            </React.Fragment>
          ))}
                    ...
                    >
                      <div className="ow-address-info">
                        <div className="ow-address-alias-row">
                          ...
                          {addr.is_default && (
                            <span className="ow-default-badge">Principal</span>
                          )}
                        </div>
          ...
          {step === 2 && (
            <div className="ow-panel">
                ...
                <div className="ow-bank-info">
                  ...
                  <div className="ow-bank-info-grid">
                    <div className="ow-bank-info-row">
                      ...
                      <span className="ow-bank-info-value">
                    ...
                    {bankAccount.alias && (
                      <div className="ow-bank-info-row">
                        ...
                        <span className="ow-bank-info-value ow-bank-info-value--highlight">
                          {bankAccount.alias}
                        </span>
                      </div>
                    )}
                    <div className="ow-bank-info-row">
                      ...
                      <span className="ow-bank-info-value ow-bank-info-value--mono">
                        {bankAccount.cbu}
                      </span>
                    </div>
                  </div>
                  <p className="ow-bank-info-note">
                    Una vez confirmado el envío y el precio final, podrás subir
                    el comprobante desde Mis Pedidos.
                  </p>
                </div>
              )}
              ...
              <div className="ow-notes-group">
                <label>
                  Notas adicionales{" "}
                  <span className="ow-optional">(opcional)</span>
                </label>
                <textarea
            ...
            <div className="ow-panel">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="ow-order-item-info">
                          ...
                          <span className="ow-order-item-qty">
                            x{item.quantity}
                          </span>
                        </div>
                        <span className="ow-order-item-price">
                ...
                <div className="ow-preview-card">
                  ...
                  {paymentMethod === "BANK_TRANSFER" && bankAccount && (
                    <p className="ow-preview-bank-hint">
                      Transferir a{" "}
                      <strong>{bankAccount.alias || bankAccount.cbu}</strong> —{" "}
                      {bankAccount.holder_name}
                    </p>
                  )}
                </div>
              ...
              <div className="ow-preview-totals">
                ...
                <p className="ow-shipping-note">
                  El costo de envío será calculado por nuestro equipo y lo
                  recibirás antes de confirmar el pago.
                </p>
              </div>
        ...
        <div className="ow-footer">
          {step === 1 ? (
            <button className="ow-btn-cancel" onClick={onClose}>
              Cancelar
            </button>
          ) : (
            <button
