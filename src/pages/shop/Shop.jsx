...
const BtnSpinner = ({ dark }) => (
  <span
    className={`shop-btn-spinner${dark ? " shop-btn-spinner--dark" : ""}`}
  />
);
      ...
      <div className="shop-page-wrapper">
        ...
        {activeTab === "shop" && (
          <div className="shop-wrapper">
            ...
            <aside
              className={`shop-filters ${showMobileFilters ? "show" : ""}`}
            >
                ...
                <div className="modal-images">
                  <div className="modal-image-wrapper">
                    ...
                    <img
                      ...
                      onError={(e) => {
                        e.currentTarget.src = `${API_URL}/images/placeholder.png`;
                      }}
                    />
                  </div>
                  {modalProduct.images?.length > 1 && (
                ...
                <div className="modal-info">
                  ...
                  <div className="modal-price-section">
                    {modalProduct.discount_percentage > 0 ? (
                      <>
                        <p className="modal-price-original">
                          ${modalProduct.price}
                        </p>
                        <p className="modal-price">
                          $
                          {modalProduct.price *
                            (1 - modalProduct.discount_percentage / 100)}
                        </p>
                  ...
                  <div className="modal-stock">
                    {modalProduct.stock > 0 ? (
                      <span
                        className={
                          modalProduct.stock <= modalProduct.min_stock
                            ? "low-stock"
                            : "in-stock"
                        }
                      >
