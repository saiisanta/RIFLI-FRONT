...
const Login = () => {
  ...
  const { login, loading: authLoading, clearError } = useAuthContext();
  ...
  return (
    <>
      ...
      <AuthPageLayout>
        ...
        {sessionExpired && (
          <div className="info-message">Tu sesión expiró. Por favor inicia sesión nuevamente.</div>
        )}
        {registered && (
          <div className="success-message">¡Registro exitoso! Revisa tu email para verificar tu cuenta.</div>
        )}
        {verified && (
          <div className="success-message-verified">
            ...
            <div className="verified-content">
              ...
              <p className="verified-subtitle">Ya podés iniciar sesión con tu cuenta</p>
            </div>
          </div>
        )}
        {logout && <div className="info-message">Sesión cerrada correctamente.</div>}
        ...
        <div className="switch-mode">
          <p>¿No tienes cuenta? <Link to="/register" className="switch-link">Regístrate aquí</Link></p>
        </div>
      </AuthPageLayout>
    </>
  );
