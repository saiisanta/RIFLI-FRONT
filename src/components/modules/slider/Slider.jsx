...
const Slider = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      // Mueve el contenido una tarjeta hacia la izquierda
      track.style.transition = 'transform 1s ease-in-out';
      track.style.transform = 'translateX(-33.33%)';

      const handleTransitionEnd = () => {
        // Mueve el primer logo al final del array (efecto loop)
    ...
    <section className="slider-section">
      ...
      <Container className="text-center">
        ...
        <p className="lead mb-3">
          Las marcas preferidas por técnicos y profesionales, por su calidad, durabilidad y confianza.
        </p>
