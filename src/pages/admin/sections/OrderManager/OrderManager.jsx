            ...
            {orders.map((order) => {
              ...
              return (
                <tr key={order.id}>
                  ...
                  <td>
                    <StatusBadge
                      status={order.payment_status || "PENDING_PROOF"}
...
const OrderManager = () => {
  ...
  const {
    ...
    updateOrderStatus,
    clearError,
  } = useOrders({ page: currentPage, limit: ITEMS_PER_PAGE });
  ...
  const handleSetShipping = useCallback(
    ...
    [setShippingCost, handleApiError, clearApiError],
  );
  ...
  const handleUpdateStatus = useCallback(
    ...
    [updateOrderStatus, handleApiError, clearApiError],
  );
